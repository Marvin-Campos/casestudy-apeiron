...
public class MenuPage extends Values {
    ...
    Processor processor3 = new Processor(999, 9999, true, true, "Superposition 301P", 7200, "P1-783191", 1, new ImageIcon(resourcesFolder + "\\processor1.png"));
    ...
    Graphics gpu1 = new Graphics(2, 3, 8, true, true, "STX 3060", 31000, "G1-306071", 1, new ImageIcon(resourcesFolder + "\\aust.png"));
    Graphics gpu2 = new Graphics(2, 3, 8, true, true, "LT 8931XT", 17000, "G1-472894", 1, new ImageIcon(resourcesFolder + "\\marvs.png"));
    Graphics gpu3 = new Graphics(2, 3, 8, true, true, "ZTX 1992", 26000, "G1-938183", 1, new ImageIcon(resourcesFolder + "\\aust.png"));
    Graphics gpu4 = new Graphics(2, 3, 8, true, true, "PL 222ZT", 12000, "G1-534012", 1, new ImageIcon(resourcesFolder + "\\marvs.png"));
    Graphics gpu5 = new Graphics(2, 3, 8, true, true, "MRV 3045AU", 22000, "G1-391831", 1, new ImageIcon(resourcesFolder + "\\aust.png"));
    ...
    Webcam wc2 = new Webcam("1920x1080", "16:9", "Black", false, "SP-Tech K301XT", 700, "W1-942424", 1, new ImageIcon(resourcesFolder + "\\webcam1.png"));
    Webcam wc3 = new Webcam("1920x1080", "16:9", "Black", false, "AP-RON CLEAR", 900, "W1-994124", 1, new ImageIcon(resourcesFolder + "\\webcam1.png"));
    Webcam wc4 = new Webcam("1920x1080", "16:9", "Black", false, "AP-RON BOXY", 800, "W1-993103", 1, new ImageIcon(resourcesFolder + "\\webcam1.png"));
    Webcam wc5 = new Webcam("1920x1080", "16:9", "Black", false, "SP-Tech KXXP", 750, "W1-993104", 1, new ImageIcon(resourcesFolder + "\\webcam1.png"));
    ...
    OfficeMouse m3 = new OfficeMouse("Ball", 1600, 3, "Black", false, "RT MX OFFICE", 900, "M1-123456", 1, new ImageIcon(resourcesFolder + "\\officeMouse.jpg"));
    GamingMouse m4 = new GamingMouse(130, false, 800, 5, "White", true, "APR MOU4 MINI", 2500, "M2-390123", 1, new ImageIcon(resourcesFolder + "\\gamingMouse.jpg"));
    OfficeMouse m5 = new OfficeMouse("Ball", 1600, 3, "Black", false, "RT MINI ", 400, "M1-382932", 1, new ImageIcon(resourcesFolder + "\\officeMouse.jpg"));
    ...
    MechanicalKeyboard kb3 = new MechanicalKeyboard("MX Cherry Reds", "Japanese", 70, "Pink", true, "Taho P001x", 5700, "K1-275022", 1, new ImageIcon(resourcesFolder + "\\mechkb1.jfif"));
    MembraneKeyboard kb4 = new MembraneKeyboard(true, true, 100, "Black", false, "Castom XP3103", 1200, "K2-193323", 1, new ImageIcon(resourcesFolder + "\\memkb1.jpg"));
    MechanicalKeyboard kb5 = new MechanicalKeyboard("MX Cherry Reds", "Japanese", 70, "Pink", true, "H3LLFIRE X", 6200, "K1-202542", 1, new ImageIcon(resourcesFolder + "\\mechkb1.jfif"));
    ...
    Monitor mon2 = new Monitor(24, "1920x1080", 144, "VA Panel", "Red", false, "SP1 POS-1", 15500, "M3-821367", 1, new ImageIcon(resourcesFolder + "\\monitor1.jpg"));
    Monitor mon3 = new Monitor(24, "1920x1080", 144, "VA Panel", "Red", false, "301X 918733", 17600, "M3-875167", 1, new ImageIcon(resourcesFolder + "\\monitor1.jpg"));
    Monitor mon4 = new Monitor(24, "1920x1080", 144, "VA Panel", "Red", false, "LOL LEGEND", 7000, "M3-831127", 1, new ImageIcon(resourcesFolder + "\\monitor1.jpg"));
    Monitor mon5 = new Monitor(24, "1920x1080", 144, "VA Panel", "Red", false, "APR MONIX", 13000, "M3-843167", 1, new ImageIcon(resourcesFolder + "\\monitor1.jpg"));
    ...
    Chassis ch2 = new Chassis("ATX", true, false, 7, "White", false, "BIG CHUNGUS", 1200, "C1-057650", 1, new ImageIcon(resourcesFolder + "\\chassis1.jpg"));
    Chassis ch3 = new Chassis("ATX", true, false, 7, "White", false, "SUS MACHINE", 3400, "C1-038520", 1, new ImageIcon(resourcesFolder + "\\chassis1.jpg"));
    Chassis ch4 = new Chassis("ATX", true, false, 7, "White", false, "FROZEN XP13", 2200, "C1-052024", 1, new ImageIcon(resourcesFolder + "\\chassis1.jpg"));
    Chassis ch5 = new Chassis("ATX", true, false, 7, "White", false, "POLAR ITYX", 7600, "C1-054520", 1, new ImageIcon(resourcesFolder + "\\chassis1.jpg"));
    ...
    Motherboard mobo2 = new Motherboard("AM4", "mATX", true, true, true, "MORBIU BG11x", 7000, "M4-031973", 1, new ImageIcon(resourcesFolder + "\\mobo1.png"));
    Motherboard mobo3 = new Motherboard("AM4", "mATX", true, true, true, "AOSTEN Y480m", 6900, "M4-058976", 1, new ImageIcon(resourcesFolder + "\\mobo1.png"));
    Motherboard mobo4 = new Motherboard("AM4", "mATX", true, true, true, "MORBIU BG12x", 5000, "M4-147924", 1, new ImageIcon(resourcesFolder + "\\mobo1.png"));
    Motherboard mobo5 = new Motherboard("AM4", "mATX", true, true, true, "AOSBIU 99XT", 8800, "M4-472740", 1, new ImageIcon(resourcesFolder + "\\mobo1.png"));

    Memory ram1 = new Memory(8, "DDR5", 3200, false, true, "MarvinX Fury", 2100, "R1-197753", 1, new ImageIcon(resourcesFolder + "\\ram1.jfif"));
    Memory ram2 = new Memory(8, "DDR5", 3200, false, true, "AustinY Ripper", 4400, "R1-152973", 1, new ImageIcon(resourcesFolder + "\\ram1.jfif"));
    Memory ram3 = new Memory(8, "DDR5", 3200, false, true, "Corvette Revenge", 1000, "R1-197352", 1, new ImageIcon(resourcesFolder + "\\ram1.jfif"));
    Memory ram4 = new Memory(8, "DDR5", 3200, false, true, "Lancer Spear", 3200, "R1-197843", 1, new ImageIcon(resourcesFolder + "\\ram1.jfif"));
    Memory ram5 = new Memory(8, "DDR5", 3200, false, true, "Picka Choo", 1100, "R1-194273", 1, new ImageIcon(resourcesFolder + "\\ram1.jfif"));
    ...
    HardDiskDrive storage2 = new HardDiskDrive(7200, 5000, false, false, "Ausvin 03301G", 1900, "S2-933961", 1, new ImageIcon(resourcesFolder + "\\ssd1.jpg"));
    SolidStateDrive storage3 = new SolidStateDrive("NVMe", "PCIE-16x", 1000, false, false, "Serra 41Large", 5800, "S1-0312301", 1, new ImageIcon(resourcesFolder + "\\ssd1.jpg"));
    HardDiskDrive storage4 = new HardDiskDrive(7200, 5000, false, false, "Ausvin 03301G", 2000, "S2-XX9141", 1, new ImageIcon(resourcesFolder + "\\ssd1.jpg"));
    SolidStateDrive storage5 = new SolidStateDrive("NVMe", "PCIE-16x", 1000, false, false, "Camps 1948xT", 7000, "S1-0330131", 1, new ImageIcon(resourcesFolder + "\\ssd1.jpg"));
